...
require(YOURBASEPATH . DS . "views/function.php");
?>
...
<link rel="stylesheet" href="templates/<?php echo $this->template ?>/css/styles/<?php echo $this->params->get('presetstyle'); ?>.css" type="text/css" />
...
<![endif]-->
<style type="text/css">
.wdb_banner a:link, .wdb_banner a:visited, .wdb_banner { color: <?php echo $this->params->get('bannerfontcolor'); ?>; }
</style>
</head>